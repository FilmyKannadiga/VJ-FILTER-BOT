...
PICS = (environ.get('PICS', 'https://envs.sh/dIh.jpg https://envs.sh/dI2.jpg')).split()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/KCW_Request_group') # Support Chat Link Without https:// or @
